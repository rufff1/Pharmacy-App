        ...
        adminUserName: var admin = _adminController.Authenticate();
            if (admin != null)
            {
                ...
                selectNumber: ConsoleHelper.WriteTextWithColor(ConsoleColor.DarkBlue, "Select Number For Use:");
                    ...
                    {
                        ConsoleHelper.WriteTextWithColor(ConsoleColor.Red, "Please Enter Correct format");
                        goto selectNumber;
                    }
                }
            ...
            {
                ConsoleHelper.WriteTextWithColor(ConsoleColor.Red, "Username or Password is wrong");
                goto adminUserName;
            }
        }
    }
